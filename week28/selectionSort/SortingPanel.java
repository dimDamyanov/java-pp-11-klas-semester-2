...
class SortingPanel extends JPanel {
	...
	public void nextStepInSorting() {
		...
		if (stage == incrementJStage) {
			...
			int minIndex = minIndex(numbers, currentJ);
			Integer temp = numbers.get(currentJ);
			numbers.set(currentJ, numbers.get(minIndex));
	...
	public static Integer minIndex(ArrayList<Integer> numbers, int startIndex) {
